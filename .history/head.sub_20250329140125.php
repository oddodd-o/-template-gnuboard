...
if (defined('G5_IS_ADMIN')) {
    ...
    echo '<link rel="stylesheet" href="'.run_replace('head_css_url', G5_CSS_URL.'/default.css"> <link rel="stylesheet" href="./resources/css/pattern_css.css?ver='.G5_CSS_VER, G5_URL).'">'.PHP_EOL;
}
?>
<!--[if lte IE 8]>
